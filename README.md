...
```text
/home/runner/work/ApiNyaEr/ApiNyaEr/downloads/carbon_1dy4gn5Z.png
```
...
```text
https://cdn2.thecatapi.com/images/c5k.jpg
```
...
result = await apinya.chatgpt(args='Tidur', mode=False)
print(result)
```
...
```json
{
    ...
    "details": "{\"message\":\"Service failed\"}\n"
}
```
