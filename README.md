...
```text
/home/runner/work/ApiNyaEr/ApiNyaEr/downloads/carbon_qFJkjEQH.png
```
...
```json
{
    "results": "**Pengertian**\n\nTidur adalah keadaan tidak sadar yang berulang secara teratur, ditandai dengan perubahan elektrofisiologis spesifik pada aktivitas otak, tonus otot yang berkurang, dan kurangnya respons terhadap rangsangan eksternal.\n\n**Jenis Tidur**\n\n* **Tidur REM (Rapid Eye Movement):** Ditandai dengan gerakan mata yang cepat, aktivitas otak yang tinggi, dan mimpi yang jelas.\n* **Tidur Non-REM (NREM):** Terbagi menjadi tiga tahap:\n    * **Tahap N1:** Tidur ringan, mudah terbangun\n    * **Tahap N2:** Tidur lebih nyenyak, lebih sulit terbangun\n    * **Tahap N3:** Tidur paling nyenyak, sangat sulit terbangun\n\n**Fungsi Tidur**\n\nFungsi tidur yang tepat belum sepenuhnya dipahami, tetapi dianggap penting untuk:\n\n* Pemulihan dan perbaikan fisik\n* Konsolidasi memori\n* Pemrosesan emosi\n* Regulazi hormon dan sistem kekebalan tubuh\n\n**Pola Tidur Normal**\n\nOrang dewasa membutuhkan sekitar 7-9 jam tidur per malam. Pola tidur normal melibatkan siklus tidur REM dan NREM yang bergantian setiap 90-120 menit.\n\n**Gangguan Tidur**\n\nBanyak gangguan yang dapat memengaruhi tidur, antara lain:\n\n* Insomnia (kesulitan tidur)\n* Hypersomnia (kantuk berlebihan)\n* Gangguan ritme sirkadian (masalah tidur pada waktu yang tepat)\n* Apnea tidur (berhenti napas saat tidur)\n\n**Dampak Kurang Tidur**\n\nKurang tidur dapat menyebabkan berbagai masalah kesehatan dan kesejahteraan, seperti:\n\n* Kelelahan dan kantuk\n* Gangguan kognitif (memori, konsentrasi)\n* Gangguan mood (lekas marah, depresi)\n* Peningkatan risiko penyakit kronis (penyakit jantung, stroke)\n* Respons sistem kekebalan tubuh yang buruk\n\n**Tips untuk Tidur yang Lebih Baik**\n\n* Tetapkan jadwal tidur teratur dan patuhi itu, bahkan di akhir pekan.\n* Ciptakan lingkungan tidur yang nyaman dan gelap.\n* Hindari kafein dan alkohol sebelum tidur.\n* Olahraga teratur, tetapi hindari olahraga berat sebelum tidur.\n* Buat rutinitas waktu tidur yang menenangkan, seperti membaca atau mandi air hangat.\n* Jika Anda tidak bisa tidur setelah 20 menit, bangun dan lakukan aktivitas santai sampai Anda merasa lelah.\n* Hindari tidur siang yang lama di siang hari.\n* Konsultasikan dengan dokter jika Anda mengalami gangguan tidur yang berkelanjutan.",
    "author": "@chakszzz",
    "success": true
}
```
