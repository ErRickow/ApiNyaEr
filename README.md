...
```text
/home/runner/work/ApiNyaEr/ApiNyaEr/downloads/carbon_bQym4ZFQ.png
```
...
```json
{
    "results": "**Pengertian Tidur**\n\nTidur adalah keadaan tidak sadar yang ditandai dengan aktivitas otak yang melambat, penurunan respons terhadap rangsangan eksternal, dan pemulihan fisik dan mental.\n\n**Tahapan Tidur**\n\nTidur terdiri dari dua tahap utama:\n\n* **Gerakan Mata Cepat (REM):** Tahap tidur di mana mata bergerak cepat di bawah kelopak mata yang tertutup. Pada tahap ini, mimpi terjadi.\n* **Gerakan Mata Tidak Cepat (Non-REM):** Tahap tidur yang tidak melibatkan gerakan mata yang cepat. Terbagi menjadi tiga subtahap:\n    * N1: Tidur ringan, mata berkedip perlahan, otot mulai rileks\n    * N2: Tidur lebih dalam, aktivitas otak melambat, denyut jantung dan pernapasan berkurang\n    * N3: Tidur paling dalam, aktivitas otak sangat lambat, sulit untuk dibangunkan\n\n**Fungsi Tidur**\n\nTidur sangat penting untuk kesehatan fisik, mental, dan emosional. Fungsi utamanya meliputi:\n\n**Fungsi Fisik:**\n\n* Pemulihan fisik (otot, tulang, jaringan)\n* Produksi hormon pertumbuhan\n* Perbaikan sistem kekebalan tubuh\n* Pengaturan suhu tubuh\n\n**Fungsi Mental:**\n\n* Konsolidasi memori\n* Belajar dan kreativitas\n* Pengendalian emosi\n* Konsentrasi dan kewaspadaan\n\n**Fungsi Emosional:**\n\n* Mengurangi stres dan kecemasan\n* Meningkatkan suasana hati\n* Mengatur nafsu makan\n\n**Durasi Tidur yang Disarankan**\n\nDurasi tidur yang dibutuhkan bervariasi tergantung usia dan gaya hidup individu, tetapi umumnya disarankan untuk orang dewasa:\n\n* 7-9 jam per malam\n\n**Gangguan Tidur**\n\nGangguan tidur adalah kondisi yang mengganggu kualitas atau durasi tidur. Beberapa jenis gangguan tidur yang umum meliputi:\n\n* Insomnia\n* Apnea tidur\n* Sindrom kaki gelisah\n* Kebiasaan tidur yang buruk (misalnya, waktu tidur tidak teratur)\n\n**Dampak Kurang Tidur**\n\nKurang tidur dapat menyebabkan berbagai masalah kesehatan dan fungsional, termasuk:\n\n* Kelelahan\n* Gangguan kognitif (penurunan memori, konsentrasi)\n* Gangguan suasana hati (cemas, depresi)\n* Masalah kardiovaskular\n* Peningkatan risiko kecelakaan",
    "author": "@chakszzz",
    "success": true
}
```
