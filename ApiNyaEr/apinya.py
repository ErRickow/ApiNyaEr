...
class ErApi:
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            url = apainier("aHR0cHM6Ly9hcGkuZXhoLmFpL2NoYXRib3QvdjEvZ2V0X3Jlc3BvbnNl").decode("utf-8")
            headers = {
            ...
            return {"results":response.json()["response"],"join":
            "@Er_Support_Group", "success": True}
        else:
            try:
